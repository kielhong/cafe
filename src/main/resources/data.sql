...
/** Article **/
INSERT INTO article(board_id, writer_id, title, content, comment_count, created_at, updated_at) VALUES
    (1, 1, '테스트 첫번째 글', '테스트 글 내용 1', 0, now(), now()),
    (1, 1, '테스트 두번째 글', '테스트 글 내용 2', 0, now(), now()),
    (1, 1, '테스트 3번째 글', '테스트 글 내용 3', 0, now(), now()),
    (1, 1, '테스트 44번째 글', '테스트 글 내용 4', 0, now(), now()),
    (1, 1, '테스트 555번째 글', '테스트 글 내용 5', 0, now(), now()),
    (1, 1, '테스트 6666번째 글', '테스트 글 내용 6', 0, now(), now()),
    (1, 1, '테스트 7*7번째 글', '테스트 글 내용 7', 0, now(), now()),
    (1, 1, '테스트 888번째 글', '테스트 글 내용 8', 0, now(), now()),
    (2, 1, '테스트 99번째 보드2 글', '테스트 글 내용 9', 0, now(), now()),
    (2, 1, '테스트 1010번째 보드 2글', '테스트 글 내용 10', 0, now(), now());
