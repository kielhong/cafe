...
INSERT INTO cafe(category_id, url, name, description, visibility, cafe_article_count, cafe_comment_count, cafe_member_count, cafe_visit_count, create_date_time) values (1,'gamecafe2','큐라레: 마법도서관 공식 카페','큐라레 공식카페입니다','PUBLIC', 898790, 1231312, 58582, 123123, '2015-03-21 01:02:03');
INSERT INTO cafe(category_id, url, name, description, visibility, cafe_article_count, cafe_comment_count, cafe_member_count, cafe_visit_count, create_date_time) values (1,'gamecafe3','샌드박스 팬 카페','샌드박스 팬 카페입니다','PUBLIC', 898790, 1231312, 58582, 123123, '2016-03-21 01:02:03');
INSERT INTO cafe(category_id, url, name, description, visibility, cafe_article_count, cafe_comment_count, cafe_member_count, cafe_visit_count, create_date_time) values (1,'gamecafe4','하스스톤 대표 카페','하스스톤 대표 카페입니다','PUBLIC', 898790, 1231312, 58582, 123123, '2016-04-21 01:02:03');
INSERT INTO cafe(category_id, url, name, description, visibility, cafe_article_count, cafe_comment_count, cafe_member_count, cafe_visit_count, create_date_time) values (1,'gamecafe5','PS Vita 카페','PS Vita 카페입니다','PUBLIC', 898790, 1231312, 58582, 123123, '2014-02-21 01:02:03');
INSERT INTO cafe(category_id, url, name, description, visibility, cafe_article_count, cafe_comment_count, cafe_member_count, cafe_visit_count, create_date_time) values (1,'gamecafe6','워프레임 한국팬카페','워프레임 한국팬카페입니다','PUBLIC', 898790, 1231312, 58582, 123123, '2016-01-21 01:02:03');
INSERT INTO cafe(category_id, url, name, description, visibility, cafe_article_count, cafe_comment_count, cafe_member_count, cafe_visit_count, create_date_time) values (1,'gamecafe7','드래곤 플라이트 사랑 모임','드래곤 플라이트 팬 카페입니다','PUBLIC', 898790, 1231312, 58582, 123123, '2016-11-21 01:02:03');
