...
public class JsonFormatTest {
    ...
    public void testSerialize() throws Exception {
        ...
        assertThat(this.json.write(category)).hasJsonPathStringValue("@.create_date_time");
        assertThat(this.json.write(category)).extractingJsonPathStringValue("@.create_date_time")
